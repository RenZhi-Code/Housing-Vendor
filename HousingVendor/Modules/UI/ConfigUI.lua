...
function ConfigUI:CreateConfigFrame()
    ...
    fontSlider:SetScript("OnValueChanged", function(self, value)
        ...
        -- Apply immediately to item list and statistics UI
        if HousingItemList and HousingItemList.ApplyFontSize then
            HousingItemList:ApplyFontSize(value)
        end
        if HousingStatisticsUI and HousingStatisticsUI.ApplyFontSize then
            HousingStatisticsUI:ApplyFontSize(value)
        end
    end)
    ...
    resetBtn:SetScript("OnClick", function()
        ...
        if HousingStatisticsUI and HousingStatisticsUI.ApplyFontSize then
            HousingStatisticsUI:ApplyFontSize(12)
        end
